...
class ApiEndpoints {
  ...
  static String ayahByNumbers(int surah, int ayah) =>
      '$_baseUrl/ayah/$surah:$ayah';

  /// Get list of all editions
  static String get editions => '$_baseUrl/edition';

  /// Get editions by format and type
  static String editionsByFormat(
    String format, {
    String? type,
    String? language,
  }) {
  ...
  static String juzWithEdition(int number, String edition) =>
      '$_baseUrl/juz/$number/$edition';

  /// Get page by number
  static String page(int number) => '$_baseUrl/page/$number';

  /// Get page with specific edition
  static String pageWithEdition(int number, String edition) =>
      '$_baseUrl/page/$number/$edition';
  ...
  static String quranInfoWithEdition(String edition) =>
      '$_baseUrl/quran/$edition';
}
